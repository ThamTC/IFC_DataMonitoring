              ...
              ">
                        <div class="d-flex mb-3 justify-content-end">
                            ...
                            <div class="date" id="fromdatepicker">
                                <input @change="changeDate" type="date" class="" id="fromdatefilter" v-model="fromDateSelection" />
                            </div>
                            <span class="ms-1">To:</span>
                            <div class="date" id="todatepicker">
                                <input @change="changeDate" type="date" class="" id="todatefilter" v-model="toDateSelection" />
                            </div>
                        </div>
                        ...
                        <div v-else class="table-wrapper">
                            ...
                            name: 'issue_detail',
                            params: { id: idx + 1 },
                          }" class="text-decoration-none">{{ idx + 1 }}</router-link>
                                        </td>
                            ...
                            params: { id: idx + 1 },
                                        ...
                                        <td style="width: 8%">
                                            <div class="progress">
                                                <div class="progress-bar bg-success" role="progressbar" :style="'width: ' + item.doneProgress + '%'" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
                                                    {{ item.doneProgress }}%
                                                </div>
                                            </div>
                                        </td>
    ...
    created() {
        ...
        const options = {
            where: {
                ...
                startDate: localISOTime.slice(0, 10) + "T00:00:00.000Z",
